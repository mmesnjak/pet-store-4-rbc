package com.miselmesnjak.petstore.config.apidoc;

import com.miselmesnjak.petstore.config.Constants;
import com.miselmesnjak.petstore.config.JHipsterProperties;
...
public class SwaggerConfiguration {
    ...
    public static final String DEFAULT_INCLUDE_PATTERN = "/api/.*|/pet.*";
